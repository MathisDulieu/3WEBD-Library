...
<<<<<<< HEAD
  ...
  }, [searchedOnce, currentPage, sortType, searchFilters, booksPerPage, reverseOrder]);
=======
                ...
                <div className='flex flex-col items-center'>
                    <div className='flex flex-wrap items-center space-y-4 md:space-y-0 sm:space-y-0 justify-center'>
                        ...
                        <div className='flex flex-col md:flex-row sm:flex-row'>
                            ...
                            <button
                                onClick={handleSearchButtonClick}
                                className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mt-4 md:mt-0 sm:mt-0'
                            >
                                Search
                            </button>
                        </div>
